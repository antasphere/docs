---
title: "Attachments"
description: "Files can travel with a deck: the spreadsheet behind a chart, the PDF of the slides, the raw data. Put them in a downloads/ folder at the root of the deck and push. Every file in…"
---
