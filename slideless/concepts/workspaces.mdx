...
([Decks](/slideless/concepts/artifact)).

## A workspace holds projects

A workspace can be split into projects ([Projects](/slideless/concepts/projects)): a name, a description, members
...
- **Within the operator's limit.** On a self-hosted instance one person can own up to
  ...
  [Deployment profiles](/slideless/self-hosting/deployment-profiles#limiting-workspace-creation).
...
([Antasphere account](/slideless/getting-started/antasphere-account)). Creating a workspace from Slideless
