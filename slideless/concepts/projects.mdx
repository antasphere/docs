---
title: "Projects"
description: "A project is a subgroup of a workspace: a name, a description, a list of members, and the decks linked to it. It is how a team that shares one workspace works on one client, one product or one campaign without opening every deck to everybody."
---

{/* GENERATED from antasphere/slideless docs/concepts/projects.md — edit there, then run `npm run sync`. */}
