---
title: "Downloads"
description: "A deck can carry files that travel with it: a spreadsheet next to the report, the PDF of the slides, the raw data behind a chart. Put them in a downloads/ folder at the root of…"
---
