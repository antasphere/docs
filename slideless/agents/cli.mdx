...
description: "slideless is the typed command-line client for a Slideless instance — the primary human/agent face of it. It signs in over email OTP (minting its own API key), pushes deck folders…"
---
...
[The deck is the artifact](/slideless/concepts/artifact),
[Versions](/slideless/concepts/versions), [Share links](/slideless/concepts/links),
[Attachments](/slideless/concepts/attachments). What each release added is the
