...
| `slideless_add_share_token`           | write | Mint a share link (name/pin/annotate/forms/downloads/bar/expiry/password: `canAnnotate`, `canSubmitForms`, `canDownload`, `showBar`, see [Share links](/slideless/concepts/links)); returns the viewer URL once |
