---
title: "Deck self-description: metadata + AGENT.md"
description: "A deck can describe itself through two complementary channels:"
---

{/* GENERATED from antasphere/slideless docs/agents/deck-self-description.md — edit there, then run `npm run sync`. */}
...
[Attachments](/slideless/concepts/attachments)): a deck that carries files should
...
[deck's own page](/slideless/concepts/artifact)), and `slideless push` prints a
...
and on the version. [References](/slideless/concepts/references) has the fields of
...
([CLI](/slideless/agents/cli#references-brand-template)).
