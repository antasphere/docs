---
title: "Upgrade"
description: "Upgrading a self-hosted instance recreates the containers on a newer image; data survives in the Docker volumes and migrations apply themselves at boot. How you trigger it depends on how you installed."
---

{/* GENERATED from antasphere/slideless docs/self-hosting/upgrade.md — edit there, then run `npm run sync`. */}
...
[the Hostinger guide](/slideless/self-hosting/hostinger#upgrading).
