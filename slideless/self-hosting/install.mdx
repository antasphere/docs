---
title: "Install"
description: "For a dedicated Hostinger VPS with automatic HTTPS and setup through hPanel, follow Install on Hostinger."
---

{/* GENERATED from antasphere/slideless docs/self-hosting/install.md — edit there, then run `npm run sync`. */}

For a dedicated Hostinger VPS with automatic HTTPS and setup through hPanel,
follow [Install on Hostinger](/slideless/self-hosting/hostinger).
...
([reverse-proxy.md](/slideless/self-hosting/reverse-proxy)) and setting `TRUST_PROXY=true` in
`.env`.
...
([env-reference.md](/slideless/reference/env-reference)).
