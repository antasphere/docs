---
title: "Install"
description: "Install Slideless on your own machine: two supported paths, both ending with the first-boot wizard in the browser."
---
...
wiring the reverse proxy ([reverse-proxy.md](/slideless/self-hosting/reverse-proxy)) and setting
