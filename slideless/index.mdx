---
title: "Slideless"
description: "Slideless is the home for what your agents build. Agents produce HTML: presentations, small apps, plans, reports. Slideless keeps each one as a deck in your account, versioned on every push, and shares it by link. Push from the CLI (or let an agent push over MCP), open the deck's page, hand out a link. No PowerPoint export, no static-host glue, no third party holding your content."
---
...
<HeroBand
  eyebrow={"Slideless"}
  title={"The home for what your agents build"}
  lede={"Agents push HTML decks; Slideless versions them and shares them by link."}
  drawing={"latitudes"}
  seed={976086463}
/>
