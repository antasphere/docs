...
<Update label="v0.6.0" description="2026-09-19">
...
<Update label="v0.5.0" description="2026-09-19">
...
<Update label="cli-v0.4.1" description="2026-09-19" tags={["CLI"]}>

The same commands as 0.4.0; the package now declares its repository, so npm can attest where it was built from.

</Update>
<Update label="cli-v0.4.0" description="2026-09-19" tags={["CLI"]}>

Every command can name the workspace it works in: `--workspace`, `SLIDELESS_WORKSPACE`, or a field of the saved profile, and `slideless workspaces` lists yours. The reference commands arrive: brands and templates are decks the workspace shares, and `slideless brand` / `slideless template` list, pull, push, publish and start from them.

</Update>
<Update label="v0.4.2" description="2026-09-17">
